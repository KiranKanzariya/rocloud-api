...
CREATE TABLE public.orders (
    ...
    CONSTRAINT orders_order_type_check CHECK (((order_type)::text = ANY (ARRAY[('Regular'::character varying)::text, ('Urgent'::character varying)::text, ('Subscription'::character varying)::text, ('BulkReturn'::character varying)::text, ('Advance'::character varying)::text]))),
...
--
-- Name: razorpay_order_index; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.razorpay_order_index (
...
--
-- Name: recurring_job_settings; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.recurring_job_settings (
    job_id character varying(100) NOT NULL,
    cron character varying(120) NOT NULL,
    enabled boolean DEFAULT true NOT NULL,
...
CREATE TABLE public.subscription_invoices (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone,
    CONSTRAINT subscription_invoices_status_check CHECK (((status)::text = ANY ((ARRAY['Pending'::character varying, 'Paid'::character varying, 'Void'::character varying])::text[])))
);
...
--
-- Name: razorpay_order_index razorpay_order_index_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.razorpay_order_index
    ADD CONSTRAINT razorpay_order_index_pkey PRIMARY KEY (razorpay_order_id);


--
-- Name: recurring_job_settings recurring_job_settings_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.recurring_job_settings
    ADD CONSTRAINT recurring_job_settings_pkey PRIMARY KEY (job_id);
...
--
-- Name: idx_reminder_log_lookup; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_reminder_log_lookup ON public.reminder_log USING btree (tenant_id, reminder_type, subject_id, created_at);
...
--
-- Name: idx_subscription_invoices_tenant; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ux_invoices_customer_period; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX ux_invoices_customer_period ON public.invoices USING btree (tenant_id, customer_id, period_from, period_to) WHERE (((status)::text <> 'Cancelled'::text) AND (is_deleted = false) AND (period_from IS NOT NULL));


--
-- Name: ux_subscription_invoices_number; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX ux_subscription_invoices_number ON public.subscription_invoices USING btree (invoice_number);


--
-- Name: ux_subscription_invoices_open_period; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX ux_subscription_invoices_open_period ON public.subscription_invoices USING btree (tenant_id, period_start) WHERE ((status)::text = 'Pending'::text);
...
--
-- Name: reminder_log reminder_log_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.reminder_log
    ADD CONSTRAINT reminder_log_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
